...
- **Codex-Template**  
  Standardized repository template defining `.agents/` directory structure, contributor documentation patterns, and development workflows used across all Midori AI projects.
